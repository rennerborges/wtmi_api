...
export default function getTemplateReminderUser({ username, schedulers = [] }) {
  return `<!doctype html>
	...
	&nbsp;</div>
	Hoje <strong>23/05/2022</strong> você terá <strong>três </strong>palestras agendadas no IF Goiano Campus Morrinhos no prédio do Núcleo da computação!&nbsp;</td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnDividerBlock" style="min-width:100%;">
